Description:
This app allows the user to create any number of card decks in order to study efficiently. It also includes enables daily notification reminders on your mobile device.

Steps to run:
1. yarn install
2. yarn start
3. Preferably, run on iOS (press 'i' on the screen after step 2 finishes).
